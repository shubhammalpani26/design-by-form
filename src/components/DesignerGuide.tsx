...
const guideSteps: GuideStep[] = [
  ...
  },
  {
    ...
    description: "Click this button to generate 3 unique design variations. Each generation uses 1 credit and creates 3 variations instantly.",
    tip: "You'll get 3 different design options to choose from!",
    targetId: "generate-button",
  },
  {
    title: "Step 4: Choose Your Favorite",
    description: "After generation, you'll see 3 variations below. Click on any variation card to select it for customization and submission.",
  ...
  {
    title: "Step 6: AR Preview Available",
    description: "The AR tab lets customers preview your furniture in their actual space! Works best with a 3D model, but 2D images also work.",
    tip: "AR preview uses AI to place furniture realistically in any room!",
    targetId: "ar-tab",
  },
];
