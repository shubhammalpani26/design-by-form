...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Creators earn 70% of the markup on every piece sold. Generate a design, list it, and Nyzora handles manufacturing and fulfillment with our verified maker network.",
  },
];
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "List your designs and earn 70% of the markup",
                  ].map((item) => (
