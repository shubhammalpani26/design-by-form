  ...
  const captionTemplates = [
    {
      ...
      templates: [
        "✨ New design alert! Just dropped my latest creation on @nyzora.design - [Product Name]. What do you think? Link in bio 🔗 #FurnitureDesign #CreatorEconomy",
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          type="text"
                          readOnly
                          value="nyzora.design/c/your-username?utm_source=instagram&utm_medium=bio"
                          className="flex-1 px-3 py-2 border border-border rounded-md bg-accent/20 text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => handleCopy("nyzora.design/c/your-username?utm_source=instagram&utm_medium=bio", "Instagram link")}
                        >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          type="text"
                          readOnly
                          value="nyzora.design/c/your-username?utm_source=facebook&utm_medium=post"
                          className="flex-1 px-3 py-2 border border-border rounded-md bg-accent/20 text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => handleCopy("nyzora.design/c/your-username?utm_source=facebook&utm_medium=post", "Facebook link")}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          type="text"
                          readOnly
                          value="nyzora.design/c/your-username?utm_source=twitter&utm_medium=tweet"
                          className="flex-1 px-3 py-2 border border-border rounded-md bg-accent/20 text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => handleCopy("nyzora.design/c/your-username?utm_source=twitter&utm_medium=tweet", "Twitter link")}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          type="text"
                          readOnly
                          value="nyzora.design/c/your-username?utm_source=email&utm_medium=newsletter"
                          className="flex-1 px-3 py-2 border border-border rounded-md bg-accent/20 text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => handleCopy("nyzora.design/c/your-username?utm_source=email&utm_medium=newsletter", "Email link")}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          type="text"
                          readOnly
                          value="nyzora.design/c/your-username?utm_source=youtube&utm_medium=description"
                          className="flex-1 px-3 py-2 border border-border rounded-md bg-accent/20 text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => handleCopy("nyzora.design/c/your-username?utm_source=youtube&utm_medium=description", "YouTube link")}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                      </div>
