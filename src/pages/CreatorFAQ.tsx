...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "How much can I earn as a creator?", a: "Creators keep 100% of the markup they set above our Manufacturing Base Price (MBP). For example, if MBP is ₹50,000 and you price at ₹75,000, you earn ₹25,000 per sale." },
  { q: "Can I set my own prices?", a: "Yes. We calculate the Manufacturing Base Price; you decide your selling price and keep 100% of the difference (markup) as a Creator." },
  ...
  { q: "How long do I earn?", a: "Forever. As long as your design is being manufactured and sold on Nyzora, you continue earning on every sale with no expiration. Creators currently keep 100% of the markup; any future platform fee will be communicated transparently in advance." },
