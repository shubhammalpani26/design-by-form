          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  Your design renders go live on the Nyzora marketplace. We handle product photography, product pages, and customer service. You focus on what you do best - creating and sharing your designs.
                </p>
          ...
          <Card className="bg-primary text-primary-foreground">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                Join hundreds of designers already earning on Nyzora
              </p>
