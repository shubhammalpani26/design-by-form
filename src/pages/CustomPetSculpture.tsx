...
const faqs = [
  ...
  },
  {
    ...
    a: "From $59 for the Petite (120 mm), $89 for the Standard (140 mm) and $139 for the Statement (196 mm). Every price includes free US shipping, arriving in 7–8 business days.",
  },
];
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6">
              {[
                ...
                "Free US shipping on every size, arriving in 7–8 business days.",
              ].map((point) => (
