...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "What is the typical lead time for orders?", a: "Nyzora Originals (personalised keepsake pieces) are produced in 3-4 days and delivered in 7-8 business days in the US. Larger marketplace furniture is manufactured on-demand with a typical lead time of 21 days; custom-sized pieces may take 28-35 days." },
        ...
        <section className="container py-16 max-w-4xl">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-muted-foreground">
                Nyzora Originals — our personalised keepsake pieces — go into production within a day of your order, take 3-4 days to make, and typically arrive in 7-8 business days in the US. Larger marketplace furniture is manufactured on-demand with a typical lead time of 21 days; custom-sized or specially finished pieces may take 28-35 days. We confirm an accurate timeline when you place your order.
              </AccordionContent>
            </AccordionItem>
