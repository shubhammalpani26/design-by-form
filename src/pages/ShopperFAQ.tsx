...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "What is the typical lead time for orders?", a: "Nyzora Originals (personalised keepsake pieces) ship in 4–5 business days in the US. Larger marketplace furniture is manufactured on-demand with a typical lead time of 21 days; custom-sized pieces may take 28-35 days." },
