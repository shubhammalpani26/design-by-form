...
const STEPS = [
  ...
  { n: "03", t: "Made in the USA", d: "Printed to order in our US network and shipped in 4–5 business days." },
];

const FAQS = [
  { q: "How long does it take?", a: "Every Original is made to order. Production starts within a day and your piece ships in 4–5 business days anywhere in the US." },
      ...
      <section className="border-b border-border">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px p-px bg-border">
            {["Made in the USA", "Ships in 4–5 business days", "One-of-one, no minimums", "Remake if it's not right"].map((t) => (
          ...
          {ORIGINALS_SKUS.map((sku) => (
            ...
            >
              <div className="aspect-[4/5] overflow-hidden bg-muted/30 mb-5">
                <img
                  src={sku.image}
                  alt={sku.imageAlt ?? `${sku.name} — personalized piece made in the USA`}
                  loading="lazy"
                  width={1024}
                  height={1280}
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="border border-border p-8 md:p-14 text-center">
          ...
          <p className="mt-4 text-sm text-muted-foreground max-w-xl mx-auto">
            ...
            Made to order in the USA, shipped in 4–5 business days.
          </p>
          ...
          <div className="border border-border p-8 md:p-12 mb-16">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-4 border-t border-l border-border">
              {[
                ...
                { n: "04", t: "Shipped to your door", d: "Made to order and shipped in 4–5 business days, with free US shipping." },
              ].map((s) => (
