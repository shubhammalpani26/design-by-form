  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description={
          sku.seo?.description ??
          `${sku.tagline} Made to order in the USA and shipped in 4–5 business days. $${sku.price}.`
        }
      ...
      <div className="container mx-auto px-4 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
        <div className="border border-border bg-muted/20">
          <img
            src={sku.image}
            alt={sku.imageAlt ?? `${sku.name} personalized piece`}
            width={1024}
            height={1280}
        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 text-[11px] tracking-[0.15em] uppercase text-muted-foreground">
            ...
            <div className="flex flex-col gap-2"><Truck className="h-4 w-4" /> Ships in 4–5 business days</div>
