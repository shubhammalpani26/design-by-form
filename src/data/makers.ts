...
export const makers: Maker[] = [
  ...
  },
  {
    id: "8",
    slug: "ug-agawane",
    name: "Artist U.G Agawane",
    location: "Mumbai, India",
    shortDescription: "Renowned hand-painted art studio founded in 1981, crafting perennial canvas artworks, custom-framed pieces, and bespoke decor commissions.",
    expertise: "Founded in 1981 by Uttam Agawane, the studio has spent over four decades creating perennial, hand-painted artworks on premium canvas. Known for a curated collection spanning traditional and contemporary styles, with deep expertise in customised commissions tailored to a client's space.",
    process: "Each piece is hand-painted on high-quality canvas using artist-grade pigments and time-tested techniques. Clients can collaborate through the decor consultancy to commission custom artworks sized and styled for their space, with optional custom framing — choosing from a range of sizes and frame styles before the finished piece is delivered to their doorstep.",
    tags: ["Verified by Nyzora", "Hand-Painted Since 1981", "Fine Art Atelier"],
    yearsActive: "40+",
    specialties: ["Hand-Painted Canvas Art", "Custom Commissions", "Custom Framing", "Decor Consultancy"],
