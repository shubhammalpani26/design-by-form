...
export const miDataset: MIDataPoint[] = [
  ...
  { id: "mi-002", orderRef: "NYZ-0001", product: "Patterned Wave Bench", creator: "Astha", maker: "Cyanique",
    stage: "routing", signal: "Process match", value: "FGF additive (PETG-CF pellet) • 1.2mm nozzle • 28% infill", confidence: 94, capturedAt: "2026-04-17" },
  ...
  { id: "mi-010", orderRef: "NYZ-0003", product: "Ribbon Lounger Chair", creator: "Posh Enterprise", maker: "Cyanique",
    stage: "routing", signal: "Process match", value: "Large-format FGF • PETG-CF pellet • internal ribbing", confidence: 92, capturedAt: "2026-04-22" },
