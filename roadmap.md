...
- [x] Build /pet-memorial-gifts SEO landing page
- [x] Build /custom-pet-sculpture SEO landing page
- [x] Wire routes in App.tsx
- [x] Footer links + sitemap entries
- [x] AI-search discoverability (robots.txt already allowed AI bots; added llms.txt)
